...
<body>
	...
	<div class="box">
		...
		<div class="container container-small">
			<br>
			<div class="admin"><h1 style="color:white;text-align:center;">管理员登录</h1></div>
			<form action="admincheck.php" method="post" onsubmit="return check(this)">
				<div class="form-group">
					<input type="text" class="form-control" placeholder="管理员账号" name="id" id="id">
				</div>
				<div class="form-group">
